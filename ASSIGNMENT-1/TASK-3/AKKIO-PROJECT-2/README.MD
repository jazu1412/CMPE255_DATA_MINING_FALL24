...
**Description**: This dataset contains 200+ financial indicators for US stocks over the period 2014-2018.  
**Columns**: Include various financial metrics such as Revenue, EPS, P/E Ratio, and many more.

## Objective
The goal of this analysis is to predict the "2019 PRICE VAR [%]" for stocks based on the provided financial indicators. This prediction can provide valuable insights for investment decisions.
